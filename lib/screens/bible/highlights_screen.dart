...
class _HighlightsScreenState extends State<HighlightsScreen> {
  ...
  void _scrollListener() {
    if (_scrollController.position.pixels >= _scrollController.position.maxScrollExtent - 200) {
      ...
      if (bibleProvider.hasMoreHighlights && !bibleProvider.isLoadingMoreHighlights && authProvider.token != null) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: bibleProvider.highlights.isEmpty
          ? const Center(
              child: Text(
          ...
          : ListView.separated(
              ...
              itemCount: bibleProvider.highlights.length + (bibleProvider.isLoadingMoreHighlights ? 1 : 0),
                          ...
                          onPressed: () async {
                            if (authProvider.token != null) {
                              ...
                              if (parsed != null) {
                                ...
                                final oldChapter = bibleProvider.currentChapter;
                                await bibleProvider.loadVerses(parsed['book']!, parsed['chapter']!);
                                await bibleProvider.removeHighlight(authProvider.token!, parsed['verse']!);
                                await bibleProvider.loadVerses(oldBook, oldChapter);
                              }
                            }
                          },
